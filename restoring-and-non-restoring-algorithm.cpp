...
int main(){
    int a, b;
    cout<<"Enter the two numbers to divide by restoring and non-restoring algorithm:";
    cin>>a>>b;
    ...
    cout<<"\n";
    int n;
    cout<<"Select 1 for restoring and 2 for non-restoring algorithm: ";
    cin>>n;
    switch(n){
        case 1:{
    ...
    if( a>=0 && b>0 ){
        cout<<"\nQuotient = ";
        display(dividend,size);
        cout<<"which is equivalent to "<<a/b;
        cout<<"\nRemainder = ";
        display(acc,size);
        cout<<"which is equivalent to "<<a%b;
    }
